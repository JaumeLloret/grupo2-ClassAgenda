...
public final class _Task {
    ...
    public _Task(Long id, String title, String description, TaskStatus status, TaskPriority priority, Long ownerId, String dueDate, LocalDateTime createdAt) {
    ...
    public _Task(String title, String description, TaskPriority priority, Long ownerId, String dueDate) {
