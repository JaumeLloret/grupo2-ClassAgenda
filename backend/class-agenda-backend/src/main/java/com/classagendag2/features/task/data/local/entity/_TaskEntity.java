...
public final class _TaskEntity {
    private Long id;
    ...
    public _TaskEntity(Long id, String title, String description, String status, String priority, Long ownerId, String dueDate, LocalDateTime createdAt) {
        this.id = id;
        this.title = title;
